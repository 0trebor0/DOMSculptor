...
let computed = (compute, dependencies = null) => defaultSculptor.computed(compute, dependencies);
let effect = (run, dependencies = null) => defaultSculptor.effect(run, dependencies);
